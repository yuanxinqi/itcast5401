 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://service.itcast.cn/", wsdlLocation = "http://localhost:12345/user?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICEIMPLSERVICE_QNAME = new QName("http://service.itcast.cn/", "UserServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:12345/user?wsdl");
    ...
    public IUserService getUserServiceImplPort() {
        return super.getPort(new QName("http://service.itcast.cn/", "UserServiceImplPort"), IUserService.class);
    }
    ...
    public IUserService getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.itcast.cn/", "UserServiceImplPort"), IUserService.class, features);
    }
